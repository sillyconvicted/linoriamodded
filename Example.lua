...
local repo = 'https://raw.githubusercontent.com/sillyconvicted/linoriamodded/main/'
...
local Window = Library:CreateWindow({
    ...
    Colors = {
        AccentColor = Color3.fromRGB(255, 255, 255),      -- Bright green accent
        ...
        -- OutlineColor = Color3.fromRGB(65, 65, 65),      -- Lighter outline
        -- RiskColor = Color3.fromRGB(255, 100, 100),   -- Custom risky element color
    }
})
